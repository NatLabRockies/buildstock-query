...
WHERE CAST(baseline.applicability AS VARCHAR) = 'true' AND baseline."in.state" = 'CO' AND baseline."in.geometry_building_type_recs" != 'Mobile Home' GROUP BY 1 ORDER BY 1