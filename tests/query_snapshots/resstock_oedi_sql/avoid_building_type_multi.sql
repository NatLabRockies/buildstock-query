...
WHERE baseline.applicability = true AND baseline."in.state" = 'CO' AND (baseline."in.geometry_building_type_recs" NOT IN ('Mobile Home', 'Multi-Family with 5+ Units')) GROUP BY 1 ORDER BY 1